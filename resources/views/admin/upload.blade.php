        ...
        <div class="upload-container">
            ...
            <form >
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4" placeholder="Deskripsi Berita"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-input-wrapper" onclick="document.getElementById('fileUploadInputTrigger').click();">
                        <input type="file" id="fileUploadInputTrigger" name="fileUploadInput" class="file-input">
                        ...
                        @foreach ($posts as $post)
                            <tr class="table-row-example">
                                ...
                                <td class="action-buttons">
                                    ...
                                    <button  class="setting-btn" title="Setting"><i class="fas fa-cog"></i></button>
