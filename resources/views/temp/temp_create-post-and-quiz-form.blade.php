        ...
        @foreach ($questions as $index => $q)
            <div wire:key="question-{{ $index }}" class="mb-6 p-4 border border-gray-300 rounded shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-3 mb-2">
                    <input type="text" wire:model="questions.{{ $index }}.a" placeholder="Jawaban A" class="border p-2 rounded">
                    <input type="text" wire:model="questions.{{ $index }}.b" placeholder="Jawaban B" class="border p-2 rounded">
                    <input type="text" wire:model="questions.{{ $index }}.c" placeholder="Jawaban C" class="border p-2 rounded">
                    <input type="text" wire:model="questions.{{ $index }}.d" placeholder="Jawaban D" class="border p-2 rounded">
                </div>
